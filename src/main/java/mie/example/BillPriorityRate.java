...
public class BillPriorityRate {

    private Connection conn;
    private Timesheet timesheet;
    private Lawyer lawyer;

    public BillPriorityRate(Connection conn, Timesheet timesheet, Lawyer lawyer) {
        this.conn = conn;
        this.timesheet = timesheet;
        this.lawyer = lawyer;
    }

    public void calculatePriorityBill() {
        float total = timesheet.hoursBilled * lawyer.hourlyRate * 1.5f;
